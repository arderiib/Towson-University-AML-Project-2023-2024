...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 26 16:00:40 2024
...
periods = [
    {"start_year": 2018, "start_month": 1, "start_day": 1, "end_year": 2020, "end_month": 3, "end_day": 22},
    {"start_year": 2020, "start_month": 3, "start_day": 23, "end_year": 2021, "end_month": 7, "end_day": 1},
    {"start_year": 2021, "start_month": 7, "start_day": 1, "end_year": 2023, "end_month": 1, "end_day": 1}
]
...
bars = plt.bar([f"{period['start_year']}-{period['end_year']}" for period in periods], period_crimes)
